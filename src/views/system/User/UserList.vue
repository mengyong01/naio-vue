    ...
    <el-container :style="{ height: containerHeight + 'px' }">
        ...
        <el-main>
            ...
            <el-table :height="tableHeight" :data="tableData.list" border stripe>
                ...
                <el-table-column align="center" width="290" label="操作">
                    <template #default="scope">
                        ...
                        <el-button type="primary" size="small" :icon="Setting" @click='assignBtn(scope.row)'>分配角色
                        </el-button>
                        <el-button type="danger" size="small" :icon="Delete" @click='deleteBtn(scope.row.id)'>删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-pagination @size-change="sizeChange" @current-change="currentChange"
                ...
                :page-size="listParm.pageSize" :total="listParm.total" layout="total, sizes, prev, pager, next, jumper"
...
const { listParm, tableData, treeClick, sizeChange, currentChange, getUserList, searchBtn, resetBtn } = useUserTable()
const { addBtn, editBtn, deleteBtn, assignBtn, userAddRef, save } = useUser(getUserList)
